...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    // NO verificar que pElement sea distinto de NULL porque sino no va a pasar la prueba. Porque un vagon puede venir vacio pero no ser NULL.
